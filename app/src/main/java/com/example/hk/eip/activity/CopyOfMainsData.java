...
public class CopyOfMainsData extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDbOpenHelper.insertColumn("TEE(Trusted Execution Environment, 신뢰 실행 환경)",
        ...
        mDbOpenHelper.insertColumn("TPM(Trusted Platform Module, 신뢰 플랫폼 모듈)",
        ...
        mDbOpenHelper.insertColumn("DLT(Distributed Ledger Technology, 분산 원장 기술)",
        ...
        mDbOpenHelper.insertColumn("OOK(On-Off Keying, 온오프 변조 방식)",
        ...
        mDbOpenHelper.insertColumn("RNN(Recurrent Neural Network, 순환 신경망)",
        ...
        mDbOpenHelper.insertColumn("DNN(Deep Neural Network, 심층 신경망)",
                "은닉층이 다중으로 이루어진 신경망", 0);
        mDbOpenHelper.insertColumn("CNN(Convolutional Neural Network, 합성곱 신경망)",
                "여러 개의 은닉층으로 이루어진 심층 신경망의 한 종류로, 2차원 구조의 데이터 처리, 영상 및 음성 분석, 객체 탐지 등" +
                        " 여러 분야에 활용되는 심층 신경망의 대표적인 모델 중 하나이다.", 0);
        mDbOpenHelper.insertColumn("CC(Cognitive Computing, 인지 컴퓨팅)",
        ...
        mDbOpenHelper.insertColumn("MMORPG(Massively Multiplayer Online Role-Playing Game, 대규모 다중 접속 온라인 역할 게임)",
        ...
        mDbOpenHelper.insertColumn("D-TDD(Dynamic Time Division Duplexing, 동적 시분할 송수신)",
        ...
        mDbOpenHelper.insertColumn("C-DRX(Connected mode Discontinuous Reception, 접속 상태 불연속 수신)",
        ...
        mDbOpenHelper.insertColumn("mMTC(massive Machine Type Communications, 대규모 사물 통신)",
                "일정 구역 안에 적게는 수십 개에서 많게는 수십만 개의 기기에 대해 사물 인터넷(IoT) 서비스를 제공하는 것", 0);
        mDbOpenHelper.insertColumn("eMBB(enhanced Mobile BroadBand, 초광대역 이동 통신)",
                "사용자가 5G 통신망을 사용할 때 체감되는 초광대역 서비스에 대해 정의한 것", 0);
        mDbOpenHelper.insertColumn("URLLC(Ultra-Reliable and Low Latency Communications, 초고신뢰 저지연 통신)",
        ...
        mDbOpenHelper.insertColumn("네트워크 슬라이싱 (network slicing)",
                "네트워크에서 하나의 물리적인 코어 네트워크 인프라를 독립된 다수의 가상 네트워크로 분리하여 각각의 네트워크를 통해 다양한 고객 맞춤형 서비스를 제공하는 것을 " +
                        "목적으로 하는 네트워크 기술", 0);
        mDbOpenHelper.insertColumn("SDN(Software-Defined Networking, 소프트웨어 정의 네트워킹)",
                "네트워크에서 제어부와 데이터 전달부를 분리하여 관리자가 소프트웨어를 통해 네트워크를 효율적으로 제어·관리할 수 있게 하는 기술",0);
        mDbOpenHelper.insertColumn("NFV(Network Functions Virtualization, 네트워크 기능 가상화)",
                "네트워크 구성에 필요한 하드웨어들을 소프트웨어적으로 구현하여 장비를 줄이는 기술", 0);
        mDbOpenHelper.insertColumn("IMT-2020(International Mobile Telecommunications-2020, 5세대 이동통신)",
                "2015년 국제 전기 통신 연합(ITU, International Telecommunication Union)에서 선정한 5세대 이동 통신(5G, Fifth Generation)의 공식 명", 0);
        mDbOpenHelper.insertColumn("인터넷 전문 은행(Internet only Bank, Direct Bank, 인터넷 전용 은행)",
        ...
        mDbOpenHelper.insertColumn("WMC(payment based Wireless Magnetic Communication, 무선 자기 통신 결제)",
                "스마트폰과 같은 모바일 기기에서 마그네틱 신호(자기장)를 발생시켜 마그네틱 카드를 결제할 수 있는 결제 단말 기에 근접시키면 결제되는 방식", 0);
        mDbOpenHelper.insertColumn("VPP(Virtual Power Plant, 가상 발전소)",
        ...
        mDbOpenHelper.insertColumn("POW(Proof-Of-Work, 작업 증명)",
        ...
        mDbOpenHelper.insertColumn("IBB(Integrated Broadcast Broadband, 방송·브로드밴드 융합 서비스)",
                "HTML5 웹 표준을 기반으로 하여 지상파 방송과 인터넷 서비스를 융합한 통합 방송 서비스", 0);
        mDbOpenHelper.insertColumn("CCA(Clear Channel Assessment, 가용 채널 평가)",
        ...
        mDbOpenHelper.insertColumn("VRD(Virtual Retinal Display, 가상 망막 디스플레이)",
        ...
        // 2017
        mDbOpenHelper.insertColumn("4D printing(fourth dimension printing, 4D 프린팅) ",
                "일정 시간이나 환경 조건이 갖추어지면 스스로 형태를 변화시키거나 제조되는 자가조립 기술이 적용된 제품을 3D 프린팅하는 기술", 0);
        mDbOpenHelper.insertColumn("USB-C(Universal Serial Bus Type-C, USB Type-C, C형 유에스비)",
        ...
        mDbOpenHelper.insertColumn("NER(Named-Entity Recognition, 개체명 인식)",
        ...
        mDbOpenHelper.insertColumn("WPAN(Wireless Personal Area Network, 단거리 무선망)",
                "가까운 거리에서 휴대용 단말기 등을 이용하여 각종 센서 장치 및 전자제품 등을 제어하고 정보를 송·수신하는 소형, 저전력, 저가의 무선 통신망", 0);
        mDbOpenHelper.insertColumn("CUI(Conversational User Interface, 대화형 사용자 인터페이스)",
        ...
        mDbOpenHelper.insertColumn("μLED(MicroLED, 마이크로 발광 다이오드)",
        ...
        mDbOpenHelper.insertColumn("MSA(MicroService Architecture, 마이크로서비스 아키텍처)",
        ...
        mDbOpenHelper.insertColumn("LSA(License Shared Access, 면허 기반 주파수 공동 사용)",
                "주파수 사용에 있어서 1차 사용자가 자신이 사용하지 않는 시간대나 지역을 면허를 받은 신규 사용자에게 계약을 통해 이용할 수 있게 하는 주파수 공동 " +
                        "사용 방식을 의미", 0);
        mDbOpenHelper.insertColumn("MCC(Mobile Cloud Computing, 모바일 클라우드 컴퓨팅)",
        ...
        mDbOpenHelper.insertColumn("WM-bus(Wireless Meter-bus, 무선 미터버스)",
        ...
        mDbOpenHelper.insertColumn("MC(Mission Critical, 미션 크리티컬)",
                "업무를 수행하는데 있어 오작동 등의 문제가 생기는 경우 조직뿐만 아니라 사회에까지 치명적인 영향을 미칠 수 있는 요소들을 의미", 0);
        mDbOpenHelper.insertColumn("MCPTT(Mission Critical Push To Talk, 미션 크리티컬 푸시투토크)",
        ...
        mDbOpenHelper.insertColumn("CPS(Cyber-Physical Systems, 사이버 물리 시스템)",
        ...
        mDbOpenHelper.insertColumn("산업 인터넷(industrial internet)",
                "미국의 제너럴 일렉트릭(GE)에서 만든 용어로, 제조·철도·전력 산업에서부터 의료·첨단 산업에까지 산업 현장 전반에서 사용하는 장비들에 " +
                        "접목된 인터넷을 의미", 0);
        mDbOpenHelper.insertColumn("SDE(Software-Defined Everything, 소프트웨어 정의 기술)",
                "이를 사용함으로써 데이터 센터, 통신망, 컴퓨터 등을 가상화함으로서 직접 하나하나 명령어를 입력하여 제어하는 것이 아닌, 프로그래밍을 통한 지능적인 제어로 효율적인" +
                        " 운영 및 관리가 가능하다.", 0);
        mDbOpenHelper.insertColumn("SDDC(Software-Defined Data Center, 소프트웨어 정의 데이터 센터)",
        ...
        mDbOpenHelper.insertColumn("ANSI lumen(American National Standards Institute lumen, 안시 루멘)",
        ...
        mDbOpenHelper.insertColumn("QKD(Quantum Key Distribution, 양자 암호 키 분배)",
                "양자 통신을 위해 비밀키를 분배하고 관리하는 기술", 0);
        mDbOpenHelper.insertColumn("양자 역학(quantum mechanics)",
                "현대 물리학의 한 분야로 양자론의 기초를 이루는 물리학이론의 체계", 0);
        mDbOpenHelper.insertColumn("QIS(Quantum Information Science, 양자 정보 과학)",
        ...
        mDbOpenHelper.insertColumn("SLAM(Simultaneous Localization And Mapping, 위치 측정 및 동시 지도화)",
                "로봇이 공간을 돌아다니면서 부착된 카메라와 센서를 이용하여 지도를 작성하는 것", 0);
        mDbOpenHelper.insertColumn("HMM(Hidden Markov Model, 은닉 마르코프 모델)",
        ...
        mDbOpenHelper.insertColumn("6LoWPAN(IPv6 over Low Power Wireless Personal Area Network, 저전력 단거리 무선망 IPv6)",
        ...
        mDbOpenHelper.insertColumn("EFF(Electronic Frontier Foundation, 전자 개척자 재단)",
                "1990년 활동가 미쉘 케이포(Mitch Kapor)와 존 페리 바를로(John Perry Barlow)가 인터넷에서의 표현의 자유, 저작물의 자유로운 사용, " +
                        "프라이버시 보호 등의 권리를 위해 설립한 국제 비영리 단체", 0);
        mDbOpenHelper.insertColumn("ESL(Electronic Shelf Label, 전자식 매대 표시기)",
        ...
        mDbOpenHelper.insertColumn("SNOC(Submarine Network Operation Center, 국제 해저 케이블 통합 관제 센터)",
                "2016년 6월 부산 송정에 설치되었으며, 아시아와 태평양 지역의 해저 통신망을 통합 관제하는 역할", 0);
        mDbOpenHelper.insertColumn("APG(Asia Pacific Gateway, 아시아 태평양 게이트웨이)",
                "아시아 지역의 트래픽 문제를 해결하기 위해 한국·일본·중국·홍콩·대만·베트남 등 9 개국 11개 지역을 연결하는 해저 광케이블", 0);
        mDbOpenHelper.insertColumn("NCP cable system(New Cross Pacific cable system, 태평양 횡단 새 해저 케이블)",
        ...
        mDbOpenHelper.insertColumn("지능정보기술",
                "인공 지능(AI)과 IBCM(IoT, Big Data, Cloud Computing, Mobile)을 결합하여 인간의 인지·학습·추론 등의 고차원적인 정보처리 능력을 구현 " +
                        "하는 것", 0);
        mDbOpenHelper.insertColumn("DX(Digital Transformation, 디지털 전환)",
                "AI, IoT, Big Data 등의 최신 디지털 기술들을 활용하여 현대의 끊임없이 변화하는 환경에 맞게 기존의 전통적인 사회를 혁신하여 경쟁력을 확보하는 것", 0);
        mDbOpenHelper.insertColumn("GDPR(General Data Protection Regulation, 개인정보보호 규정)",
        ...
        mDbOpenHelper.insertColumn("MDFPP(Mobile Device Fundamentals Protection Profile, 모바일 기기 기반 보호프로파일)",
        ...
        mDbOpenHelper.insertColumn("PDR(Peak Data Rate, 최고 전송 속도)",
        ...
        mDbOpenHelper.insertColumn("OTA(Over-The-Air programming, 무선 프로그래밍 갱신)",
                "무선 통신망에서 시스템 등록에 관한 정보를 무선 채널을 통해 송.수신하여, 해당 기기의 설정이나 소프트웨어 등을 갱신하는 방법으로, 실시간으로 각 기기의 설정, " +
                        "펌웨어 등을 갱신하여 최신 상태를 유지하게 한다.", 0);
        mDbOpenHelper.insertColumn("Immersive VR(Immersive Virtual Reality, 실감형 가상 현실)",
        ...
        mDbOpenHelper.insertColumn("ROUTE(Real-time Object delivery over Unidirectional Transport, 루트)",
        ...
        mDbOpenHelper.insertColumn("ESG(Electronic Service Guide, 전자 서비스 안내)",
        ...
        mDbOpenHelper.insertColumn("CDO(Chief Data Officer, 데이터 최고 책임자)",
        ...
        // 보안 관리
        mDbOpenHelper.insertColumn("PET(Privacy Enhancing Technology, 프라이버시 강화 기술)",
        ...
        mDbOpenHelper.insertColumn("DRM(Digital Rights Management, 디지털 저작권 관리)",
        ...
        mDbOpenHelper.insertColumn("IDS(Intrusion Detection System, 침입 탐지 시스템)",
                "컴퓨터 시스템의 비정상적인 사용, 오용, 남용 등을 실시간으로 탐지하는 시스템", 0);
        mDbOpenHelper.insertColumn("RFID(Radio Frequency IDentification, 전파 식별)",
        ...
        mDbOpenHelper.insertColumn("DLP(Data Leakage/Loss Prevention, 데이터 유출 방지)",
                "내부정보 유출방지 솔루션. 사내 직원이 사용하는 PC와 네트워크 상의 모든 정보를 검색하고 사용자의 행위를 탐지, 통제해 외부로의 유출을 사전에 막는다.", 0);
        mDbOpenHelper.insertColumn("CC(Common Criteria, 공통 평가 기준)",
        ...
        mDbOpenHelper.insertColumn("HDCP(High-bandwidth Digital Content Protection, 고대역폭 디지털 콘텐츠 전송 보호)",
        ...
        mDbOpenHelper.insertColumn("CCL(Creative Commons License, 저작물 이용 약관)",
                "자신의 창작물에 대하여 일정한 조건을 명시하여 타인이 자유롭게 이용할 수 있는 라이선스", 0);
        mDbOpenHelper.insertColumn("PIA(Privacy Impact Assessment, 개인정보 영향평가 제도)",
                "개인 정보를 활용하는 새로운 정보시스템의 도입 및 기존 정보시스템의 중요한 변경 시 시스템의 구축, 운영이 기업의 고객은 물론 국민의 사생활에 " +
                        "미칠 영향에 대해 미리 조사, 분석, 평가하는 제도", 0);
        mDbOpenHelper.insertColumn("RPO(Recovery Point Objective, 목표 복구 시점)",
                "조직에서 발생한 여러가지 재난 상황으로, IT 시스템이 마비되었을 때 각 업무에 필요한 데이터를 여러 백업 수단을 활용하여 복구할 수 있는 기준점", 0);
        mDbOpenHelper.insertColumn("ICMP(Internet Control Message Protocol, 인터넷 제어 메시지 프로토콜)",
        ...
        mDbOpenHelper.insertColumn("WEP(Wired Equivalent Privacy, 유선급 프라이버시)",
        ...
        mDbOpenHelper.insertColumn("IPSec(IP security protocol, IP 보안 프로토콜)",
                "안전에 취약한 인터넷에서 안전한 통신을 실현하는 통신 규약. 인터넷상에 전용 회선과 같이 이용 가능한 가상적인 전용 회선을 구축하여 데이터를 " +
                        "도청당하는 등의 행위를 방지하기 위한 통신 규약이다.", 0);
        mDbOpenHelper.insertColumn("OTP(One-Time Password, 일회용 패스워드)",
        ...
        mDbOpenHelper.insertColumn("i-PIN(internet Personal Identification Number, 인터넷 개인식별번호)",
                "대면 확인이 불가능한 인터넷상에서 주민등록번호를 대신해 본인임을 확인받을 수 있는 사이버 신원 인증 방법론이다.", 0);
        mDbOpenHelper.insertColumn("BCP(Business Continuity Planning, 업무 연속성 계획)",
                "재난 발생 시 비즈니스의 연속성을 유지하기 위한 계획", 0);
        mDbOpenHelper.insertColumn("CRL(Certificate Revocation List, 인증서 폐기 목록)",
        ...
        mDbOpenHelper.insertColumn("SAM(Secure Application Module)",
                "스마트 카드 보안 응용 모듈. 카드 판독기 내부에 장착되어 카드와 단말기의 유효성을 인증하고 통신 데이터를 암호화하여 정보의 노출 방지 및 " +
                        "통신 메시지의 인증 및 검증한다.", 0);
        mDbOpenHelper.insertColumn("CLMS(Copyright License Management System, 저작권라이선스 통합관리시스템)",
        ...
        mDbOpenHelper.insertColumn("정부 개인식별번호(Goverment-Personal Identification Number)",
                "정부가 추진하고 있는 주민 등록 번호 대체 수단. 주민 번호 오남용, 도용 등 개인 정보 보호를 강화하기 위해 공공 기관 웹 사이트 회원 가입이나" +
                        " 게시판 이용 시 이를 전 공공 기관에서 사용해야 한다. 민간 부분에서 사용 중인 인터넷 개인 식별 번호와 연계하여 개인이 하나의 PIN을 이용하여 사용할 수 있다.", 0);
        ...
        mDbOpenHelper.insertColumn("소프트웨어 에스크로(임치)(Software Escrow)",
                "소프트웨어 개발자의 지식재산권을 보호하고 사용자에게는 저렴한 비용으로 소프트웨어를 안정적으로 사용하고 유지 보수를 받을 수 있도록 " +
        ...
        mDbOpenHelper.insertColumn("CAPTCHA(Completely Automated Public Turing test to tell Computers and Humans Apart, 자동 계정 생성 방지 기술)",
        ...
        mDbOpenHelper.insertColumn("CTI(Cyber Threat Intelligence, 지능형 사이버 위협 대응)",
        ...
        mDbOpenHelper.insertColumn("DDoS(Distributed Denial of Service, 분산 서비스 거부 공격)",
        ...
        mDbOpenHelper.insertColumn("티비싱(Tvishing)",
                "텔레비전(TV)과 개인정보 낚시질을 뜻하는 피싱(Phishing)의 합성어. 스마트TV에 악성 소프트웨어를 설치해 스마트TV에 대한 최고 접근권한을 획득할" +
                        " 수 있다.", 0);
        mDbOpenHelper.insertColumn("APT(Advanced Persistent Threats, 지능형 지속 위협)",
        ...
        mDbOpenHelper.insertColumn("Malware(Malicious Software, 악성 소프트웨어)",
        ...
        mDbOpenHelper.insertColumn("Hybrid app(Hybrid mobile application, 하이브리드 앱)",
        ...
        mDbOpenHelper.insertColumn("mmWave(millimeter wave, 밀리미터파)",
        ...
        mDbOpenHelper.insertColumn("WebGL(Web-based Graphics Library, 웹 기반 그래픽스 라이브러리)",
        ...
        mDbOpenHelper.insertColumn("RDFa(Resource Description Framework in attributes, 자원 기술 프레임워크 속성)",
        ...
        mDbOpenHelper.insertColumn("HEIF(High Efficiency Image File Format, 고효율 이미지 파일 형식)",
        ...
        mDbOpenHelper.insertColumn("물리 컴퓨팅(Physical computing)",
                "현실 세계의 아날로그 정보를 인지하여 그에 맞게 대응할 수 있도록 센서와 마이크로컨트롤러 등의 하드웨어 장치와 소프트웨어로 컴퓨팅 시스템을 만드는 것." +
                        ...
                        "직접 제작하는 것을 의미한다.", 0);
        mDbOpenHelper.insertColumn("AGI(Artificial General Intelligence, 범용 인공 지능)",
        ...
        mDbOpenHelper.insertColumn("CT(Computational Thinking, 컴퓨팅 사고)",
        ...
        mDbOpenHelper.insertColumn("E-UTRA(Evolved UMTS(Universal Mobile Telecommunications System) Terrestrial Radio Access, Evolved UTRA, 진화된 범용 지상 무선 접속 기술)",
                "엘티이(LTE) 이동 통신에서 무선 접속망(E-UTRAN)을 구성하는 단말과 기지국 사이의 무선 접속 기술", 0);
        mDbOpenHelper.insertColumn("E-UTRAN(Evolved UMTS(Universal Mobile Telecommunications System) Terrestrial Radio Access Network, Evolved UTRAN, 진화된 범용 지상 무선 접속망)",
                "엘티이(LTE) 이동 통신의 무선 접속망", 0);
        mDbOpenHelper.insertColumn("FWA(Fixed Wireless Access, 고정 무선 접속)",
        ...
        mDbOpenHelper.insertColumn("EPC(Evolved Packet Core, 진화된 패킷 핵심망)",
        ...
        mDbOpenHelper.insertColumn("5G(5th Generation, 5세대 이동 통신)",
                "국제 전기 통신 연합(ITU)에서 정한 공식 명칭은 아이엠티 2020(IMT-2020)이지만, 이동 통신 시장에서는 세대로 구분하여 이 용어를 사용", 0);
        mDbOpenHelper.insertColumn("WA(Wasm, WebAssembly, 웹어셈블리)",
        ...
        // 그 외 최근 IT 용어들 (page3)
        mDbOpenHelper.insertColumn("SMV display(Super Multi-View display, 초다시점 디스플레이)",
        ...
        mDbOpenHelper.insertColumn("3DOF(three Degrees Of Freedom, 자유도 3)",
        ...
        // 그 외 최근 IT 용어들 (page4)
        mDbOpenHelper.insertColumn("ASO(App Store Optimization, 앱 스토어 최적화)",
        ...
        mDbOpenHelper.insertColumn("MWCNT(Multi-Walled Carbon NanoTube, MWNT, 다중벽 탄소 나노튜브)",
        ...
        mDbOpenHelper.insertColumn("PCI-DSS(Payment Card Industry - Data Security Standard, 지불 카드 보안 표준)",
                "지불 카드 소유자의 개인정보, 거래 정보 등을 안전하게 보호하기 위해 지불 카드 결제의 모든 과정에 필요한 보안 요구 사항을 규정한 국제 데이터 보안 표준", 0);
        mDbOpenHelper.insertColumn("e-sports(electronic sports, 전자 스포츠)",
                "온라인상에서 겨루는 게임을 통틀어 가리키는 용어", 0);
        mDbOpenHelper.insertColumn("XaaS(Everything as a Service, aaS, 서비스형 시스템)",
        ...
        mDbOpenHelper.insertColumn("CNT FEL(Carbon NanoTube Field Emission Lamp, 탄소 나노튜브 전계 방출 램프)",
        ...
        mDbOpenHelper.insertColumn("CNT BLU(Carbon NanoTube BackLight Unit, 탄소 나노튜브 백라이트 유닛)",
                "고속 순간 발광에 의한 잔상 제거 같은 장점으로 고화질 TV용 디스플레이에 활용되는 LCD 디스플레이", 0);
        mDbOpenHelper.insertColumn("FaaS(Functions as a Service, 서비스형 함수)",
        ...
        mDbOpenHelper.insertColumn("TPC(Transmit Power Control, 송신 전력 제어)",
